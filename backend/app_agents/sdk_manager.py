...
async def create_agent_session(session_id: str, name: str, instructions: str, model: str = "gpt-4.1-mini") -> Dict[str, Any]:
...
async def run_agent_turn(session_id: str, user_input: str, agent_spec: Dict[str, Any]) -> Dict[str, Any]:
    session = get_or_create_session(session_id)
    ...
    return {
        ...
        "tool_calls": [getattr(i, "tool_name", None) for i in result.new_items if hasattr(i, "tool_name")],
    }
