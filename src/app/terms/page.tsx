...
export default function TermsPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 text-gray-800">
      ...
      <p className="text-sm mb-3">You are responsible for the accuracy of information you provide. We may update these Terms from time to time.</p>
      <p className="text-sm">If you have questions, contact us.</p>
    </main>
  );
}
