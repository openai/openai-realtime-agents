...
import { getNextResponse, supervisorAgentInstructions, supervisorAgentTools } from './supervisorAgent';
...
- getNextResponse(relevantContextFromLastUserMessage="Wants to know what their current plan includes")
