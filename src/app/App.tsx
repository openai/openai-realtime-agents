...
import { realEstateScenario } from "@/app/agentConfigs/real-estate-agent";
  ...
  const connectToRealtime = async () => {
    ...
    if (sdkScenarioMap[agentSetKey]) {
      ...
      try {
        ...
        // Temporarily disabled guardrail due to API incompatibility with v0.2.1
        ...
        await connect({
          ...
          outputGuardrails: [], // Disabled until /api/responses is fixed for v0.2.1
          extraContext: {
